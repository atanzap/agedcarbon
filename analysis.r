...
# Fig S1 – compare estimates of resource use with and without H
# Fig S2 – compare estimates with and without lipid correction of 13C
# Fig S3 – posterior comparison between consumers and DOC pool
# Fig S4 – isotope biplots
# Fig S5 – histogram of algal 13C compared to Ishikawa dataset  https://link.springer.com/article/10.1007/s11284-018-1623-z
...
############################################################
### Fig S2 – compare estimates with and without lipid correction
############################################################
